...
class YouTube {
  constructor(configuration) {
    ...
    this.etags = {};
    this.activeBroadcastVideoId = null;
  }
  ...
  getChannelStatus() {
    ...
    const videoId = this.activeBroadcastVideoId
      ? Promise.resolve(this.activeBroadcastVideoId)
      : this.getActiveLiveBroadcastsVideoId().then((activeBroadcastVideoId) => {
          this.activeBroadcastVideoId = activeBroadcastVideoId;
          return this.activeBroadcastVideoId;
        });
    return videoId
      .then((id) =>
